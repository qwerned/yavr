...
Обновляетесь со сборки до 0.2.0 (тогда bundle id был `com.yavr.vox`)?
macOS считает переименованное приложение новым: доступ к микрофону и
Универсальному доступу нужно выдать ещё раз, а старые записи «YAVR» в
Системных настройках → Конфиденциальность лучше удалить. Словарь, статистика
и настройки переезжают сами при первом запуске.
